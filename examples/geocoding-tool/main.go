...
func main() {
	...
	framework, err := core.NewFramework(tool,
		...
		core.WithMiddleware(telemetry.TracingMiddleware("geocoding-tool")),
	)
	if err != nil {
	...
	log.Println("Geocoding Tool Service Starting...")
	log.Println("Telemetry: Enabled")
	log.Printf("Server Port: %d\n", port)
	log.Println("API: Nominatim (OpenStreetMap)")
	log.Println()
