...
type Orchestrator interface {
	...
	ExecutePlan(ctx context.Context, plan *routing.RoutingPlan) (*ExecutionResult, error)
...
type OrchestratorResponse struct {
	...
	RoutingMode     routing.RouterMode     `json:"routing_mode"`
...
type Executor interface {
	...
	Execute(ctx context.Context, plan *routing.RoutingPlan) (*ExecutionResult, error)
	
	// ExecuteStep executes a single routing step
	ExecuteStep(ctx context.Context, step routing.RoutingStep) (*StepResult, error)
...
func DefaultConfig() *OrchestratorConfig {
	return &OrchestratorConfig{
		RoutingMode:       routing.ModeHybrid,
